...
Even though BAPIs are not marked as obsolote by SAP and they still find usage in cloud environments, SAP recommend to replace them with released RAP Business Objects if the relevant SAP System and the business scenario suit. 
